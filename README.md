...
So that each row of the database can be uniquely identified. Without this the database would have no way to ensure that the proper record(s) are returned.
